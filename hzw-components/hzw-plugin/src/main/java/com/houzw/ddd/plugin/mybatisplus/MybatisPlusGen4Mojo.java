package com.houzw.ddd.plugin.mybatisplus;
...
import com.houzw.ddd.plugin.mybatisplus.config.PluginDataSourceConfig;
import com.houzw.ddd.plugin.mybatisplus.config.PluginGlobalConfig;
import com.houzw.ddd.plugin.mybatisplus.config.PluginPackageConfig;
import com.houzw.ddd.plugin.mybatisplus.config.PluginStrategyConfig;
import com.houzw.ddd.plugin.mybatisplus.generator.AutoGenerator;
import com.houzw.ddd.plugin.mybatisplus.generator.ConfigBuilder;
...
//        strategyConfig.setTablePrefix("hzw");
        ...
        strategyConfig.setEntityLombokModel(strategy.isEntityLombokModel());
        // 设置entity的父类
        ...
        Optional.ofNullable(strategy.getTableFillList()).ifPresent(tfl -> {
            List<TableFill> fillList = new ArrayList<>();
            tfl.stream().forEach(fill -> {
                String[] fills = fill.split(":");
                fillList.add(new TableFill(fills[0],FieldFill.valueOf(fills[1])));
            });
